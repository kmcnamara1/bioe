...
class UIWindow(QWidget):
    def __init__(self, parent=None):
        ...
        fontsize = round(24 * RES_SCALING)
        # stylesheet = {"font: {}pt \".AppleSystemUIFont\"; \n"
        #         "background-color: rgb(255, 255, 255);\n"
        #         "color: #7f7f7f".format(fontsize)}
        self.label_3.setStyleSheet("font: {}pt \".AppleSystemUIFont\"; \n"
                "background-color: rgb(255, 255, 255);\n"
                "color: #7f7f7f".format(fontsize))
        ...
        self.label_4.setStyleSheet("font: {}pt \".AppleSystemUIFont\"; \n"
                "background-color: rgb(255, 255, 255);\n"
                "color:#323232".format(fontsize))
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(220, 10, 171, 31))
        self.label_5.setStyleSheet("font: {}pt \".AppleSystemUIFont\"; \n"
                "background-color: rgb(255, 255, 255);\n"
                "color:#323232".format(fontsize))
        ...
        fontsize = round(14 * RES_SCALING)
        self.label_6.setStyleSheet("font: {}pt \".AppleSystemUIFont\"; \n"
                "background-color: rgb(255, 255, 255);\n"
                "color: #7f7f7f".format(fontsize))
        ...
        self.label_7.setStyleSheet("font: {}pt \".AppleSystemUIFont\"; \n"
                "background-color: rgb(255, 255, 255);\n"
                "color:#323232".format(fontsize))
        ...
        fontsize = round(14*RES_SCALING)
        self.label_8.setStyleSheet("font: {}pt \".AppleSystemUIFont\"; \n"
                "background-color: rgb(255, 255, 255);\n"
                "color: #7f7f7f".format(fontsize))
        ...
        fontsize = round(24*RES_SCALING)
        self.label_9.setStyleSheet("font: {}pt \".AppleSystemUIFont\"; \n"
                "background-color: rgb(255, 255, 255);\n"
                "color:#323232".format(fontsize))
        ...
        fontsize = round(18*RES_SCALING)
        self.label_10.setStyleSheet("font: {}pt \".AppleSystemUIFont\"; \n"
                "background-color: rgb(255, 255, 255);\n"
                "color: #7f7f7f".format(fontsize))
        ...
        fontsize = round(13*RES_SCALING)
        self.label_14.setStyleSheet("font: {}pt \".AppleSystemUIFont\";".format(fontsize))
...
###############################################################################################################
        ...
        fontsize = round(18*RES_SCALING)
        self.label.setStyleSheet("font: {}pt \".AppleSystemUIFont\";\n"
                "color: rgb(37,39,51)".format(fontsize))
...
class Ui_PatientHistoryWindow(QWidget):
    def __init__(self, parent=None):
        ...
        fontsize = round(24*RES_SCALING)
        self.pastSesTitle.setStyleSheet("font: {}pt \".AppleSystemUIFont\"; \n"
                "background-color: rgb(255, 255, 255);\n"
                "color: #7f7f7f".format(fontsize))
...
class UIinitPatientSetUp(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        fontsize = round(14* RES_SCALING)
        self.labelPatientsName.setStyleSheet("font: {}pt \".AppleSystemUIFont\";\n"
                "background-color: rgb(255, 255, 255);\n"
                "color: rgb(37,39,51);".format(fontsize))
        ...
        fontsize = round(14*RES_SCALING)
        self.findmuscleLabl.setStyleSheet("font: {}pt \".AppleSystemUIFont\";\n"
                "color: rgb(37,39,51)".format(fontsize))
        ...
        fontsize = round(14*RES_SCALING)
        self.exampleLabel.setStyleSheet("font: {}pt \".AppleSystemUIFont\";\n"
                "color: rgb(37,39,51)".format(fontsize))
